...
public class AddLifeStrategy extends BasicCollisionStrategy implements CollisionStrategy{
    ...
    public AddLifeStrategy(BrickerGameManager brickerGameManager, ImageReader imageReader, Vector2 brickCoords) {
    ...
    public void onCollision(GameObject obj1, GameObject obj2) {
        ...
        Renderable heartImage = this.imageReader.readImage(Constants.ASSETS_HEART_PNG, true);
